...
// ============ REASSIGN MODAL ============
const ReassignModal = ({ isOpen, onClose, pkg, theme, addToast }) => {
...
// ============ RETURN MODAL ============
const ReturnModal = ({ isOpen, onClose, pkg, theme, addToast }) => {
...
function LocQarERPInner() {
  ...
  return (
    <div className="min-h-screen flex" style={{ backgroundColor: theme.bg.primary, fontFamily: theme.font.primary }}>
        ...
        <ReassignModal isOpen={!!reassignPackage} onClose={() => setReassignPackage(null)} pkg={reassignPackage} theme={theme} addToast={addToast} />
        <ReturnModal isOpen={!!returnPackage} onClose={() => setReturnPackage(null)} pkg={returnPackage} theme={theme} addToast={addToast} />
